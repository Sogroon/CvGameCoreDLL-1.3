...
/************************************************************************************************/
		...
		.value("WIDGET_HELP_CITY_CRIME", WIDGET_HELP_CITY_CRIME)
...
/************************************************************************************************/
	...
	python::enum_<CivNameTypes>("CivNameTypes")
		.value("NO_CIVNAME", NO_CIVNAME)
		;
...
/************************************************************************************************/
		.value("UNITAI_DIPLOMAT", UNITAI_DIPLOMAT)
/************************************************************************************************/
...
/************************************************************************************************/
		...
		.value("AUTOMATE_NATIONAL_DEFENSE", AUTOMATE_NATIONAL_DEFENSE)
...
/************************************************************************************************/
		.value("MISSION_BRIBE_BARBARIAN", MISSION_BRIBE_BARBARIAN)
		.value("MISSION_GOODWILL", MISSION_GOODWILL)
/************************************************************************************************/
/* Great Diplomat MOD               END                                                  		*/
/************************************************************************************************/
...
/* Great Diplomat MOD               START                                                  		*/
/************************************************************************************************/
		.value("COMMAND_COLONIZE_BARBARIANS", COMMAND_COLONIZE_BARBARIANS)
		.value("COMMAND_FORCE_PEACE", COMMAND_FORCE_PEACE)
		.value("COMMAND_UPGRADE_IMPROVEMENTS", COMMAND_UPGRADE_IMPROVEMENTS)
/************************************************************************************************/
/* Great Diplomat MOD               END                                                  		*/
/************************************************************************************************/
...
/************************************************************************************************/
		...
		.value("TRADE_CEASE_RELATIONS", TRADE_CEASE_RELATIONS)
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
...
/************************************************************************************************/
		...
		.value("CONTACT_TRADE_CEASE_RELATIONS", CONTACT_TRADE_CEASE_RELATIONS)
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
...
//		.value("MODDEROPTION_AI_FLEXIBLE_DIFFICULTY_MIN_DIFFICULTY", MODDEROPTION_AI_FLEXIBLE_DIFFICULTY_MIN_DIFFICULTY)  //45deg: temporarily removed
//		.value("MODDEROPTION_AI_FLEXIBLE_DIFFICULTY_MAX_DIFFICULTY", MODDEROPTION_AI_FLEXIBLE_DIFFICULTY_MAX_DIFFICULTY)  //45deg: temporarily removed		
		...
		.value("MODDEROPTION_HIDE_NATIONAL_DEFENSE", MODDEROPTION_HIDE_NATIONAL_DEFENSE)
		.value("MODDEROPTION_AUTO_NATIONAL_DEFENSE_MIN_COMBAT_ODDS", MODDEROPTION_AUTO_NATIONAL_DEFENSE_MIN_COMBAT_ODDS)
	...
	python::enum_<ModderGameOptionTypes>("ModderGameOptionTypes")
		...
		.value("MODDERGAMEOPTION_REALISTIC_TIMESCALE", MODDERGAMEOPTION_REALISTIC_TIMESCALE)
		.value("MODDERGAMEOPTION_CONTACT_DECAY", MODDERGAMEOPTION_CONTACT_DECAY)
		
		.value("NUM_MODDERGAMEOPTION_TYPES", NUM_MODDERGAMEOPTION_TYPES)
	;
	
	
		python::enum_<DiplomacyRequestType>("DiplomacyRequestType")
			.value("NO_REQUEST", NO_REQUEST)
			
			.value("EMBASSY_REQUEST", EMBASSY_REQUEST)
			.value("OPEN_BORDERS_REQUEST", OPEN_BORDERS_REQUEST)
			.value("TRIBUTE_REQUEST", TRIBUTE_REQUEST)
			.value("UNIT_TRADING_REQUEST", UNIT_TRADING_REQUEST)

			.value("NUM_DIPLOMACY_REQUEST_TYPES", NUM_DIPLOMACY_REQUEST_TYPES)
		;
		
		python::enum_<DiplomacyRequestAction>("DiplomacyRequestAction")
			.value("NO_ACTION", NO_ACTION)
			
			.value("DEFAULT_ACTION", DEFAULT_ACTION)
			.value("ALWAYS_ASK", ALWAYS_ASK)
			.value("ALWAYS_REJECT", ALWAYS_REJECT)
			.value("ALWAYS_ACCEPT", ALWAYS_ACCEPT)

			.value("NUM_DIPLOMACY_REQUEST_ACTIONS", NUM_DIPLOMACY_REQUEST_ACTIONS)
		;
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
