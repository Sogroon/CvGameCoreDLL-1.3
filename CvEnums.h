...
/************************************************************************************************/
	...
	BUTTONPOPUP_FIELD_COMMANDER_TUTORIAL,
	BUTTONPOPUP_DARK_AGE,
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
...
/************************************************************************************************/
	...
	// Movement Limits by 45deg - START  (f1rpo: Position swapped w/ GAMEOPTION_NO_FUTURE)
	GAMEOPTION_MOVEMENT_LIMITS,
...
/************************************************************************************************/
	...
	GAMEOPTION_NO_MODERN_ERA,
	GAMEOPTION_NO_INDUSTRIAL_ERA,
	GAMEOPTION_NO_RENAISSANCE_ERA,
	GAMEOPTION_NO_MEDIEVAL_ERA,
	GAMEOPTION_NO_CLASSICAL_ERA,
	// </f1rpo>
};
...
enum UnitAITypes			// Exposed to Python
{
	...
	UNITAI_HUNTER,
	UNITAI_DIPLOMAT, // Great Diplomat MOD
...
/************************************************************************************************/
	MISSION_BRIBE_BARBARIAN,
	MISSION_GOODWILL,
/************************************************************************************************/
/* Great Diplomat MOD               END                                                  		*/
/************************************************************************************************/
	//Afforess Great Prophet Spread Religion
	MISSION_SPREAD_FAITH,
	MISSION_BUTCHER,
	MISSION_HERD,
...
/* Great Diplomat MOD               START                                                  		*/
/************************************************************************************************/
	COMMAND_COLONIZE_BARBARIANS,
	COMMAND_FORCE_PEACE,
	COMMAND_UPGRADE_IMPROVEMENTS,
/************************************************************************************************/
/* Great Diplomat MOD               END                                                  		*/
/************************************************************************************************/
...
/************************************************************************************************/
	...
	, GAMEMESSAGE_UPDATE_RANDOM_SEEDS
	, GAMEMESSAGE_RESYNC_PACKET,
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
...
//	MODDEROPTION_AI_FLEXIBLE_DIFFICULTY_MIN_DIFFICULTY, //45deg: temporarily removed
//	MODDEROPTION_AI_FLEXIBLE_DIFFICULTY_MAX_DIFFICULTY,	//45deg: temporarily removed
	...
	MODDEROPTION_HIDE_NATIONAL_DEFENSE,
	MODDEROPTION_AUTO_NATIONAL_DEFENSE_MIN_COMBAT_ODDS,
	MODDEROPTION_HIDE_COLORED_TEXT,
...
enum ModderGameOptionTypes
{
	...
	MODDERGAMEOPTION_REALISTIC_TIMESCALE,
	MODDERGAMEOPTION_CONTACT_DECAY,
...
//Afforess: AI Espionage Strategies
enum EspionagePlans
{
	NO_ESPIONAGE_PLAN = -1,
	//Defensive (spies only in our cities)
	ESPIONAGE_DEFENSIVE,
	//Steal techs
	ESPIONAGE_TECHNOLOGY,
	//Disrupt enemy progress through poison/unhappiness/revolts/civics/religions
	ESPIONAGE_DISRUPTIVE,
	//Disrupt enemy forces & resources
	ESPIONAGE_OFFENSIVE,
	//Do missions that will trigger a war (nuke, bribe city)
	ESPIONAGE_PREPARE_OFFENSIVE,
	//Steal gold 
	ESPIONAGE_FINANCIAL,
...
{
	NO_ESPIONAGE_ROLE = -1,
	DEFENSIVE_ESPIONAGE_ROLE,
	OFFENSIVE_ESPIONAGE_ROLE,

	NUM_ESPIONAGE_ROLES
};

enum DiplomacyRequestType
{
	NO_REQUEST = -1,
	
	EMBASSY_REQUEST,
	OPEN_BORDERS_REQUEST,
	TRIBUTE_REQUEST,
	UNIT_TRADING_REQUEST,
	
	NUM_DIPLOMACY_REQUEST_TYPES
};

enum DiplomacyRequestAction
{
	NO_ACTION = -1,
