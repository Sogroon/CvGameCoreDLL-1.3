...
// BUG - Building Additional Commerce - end
		...
		.def("getCurrentStateReligionHealth", &CyCity::getCurrentStateReligionHealth, "int ()")
		.def("getStateReligionHealth", &CyCity::getStateReligionHealth, "int (int /*ReligionTypes*/ ReligionID)")
		.def("changeStateReligionHealth", &CyCity::changeStateReligionHealth, "void (int /*ReligionTypes*/ ReligionID, iChange)")		
...
/************************************************************************************************/
		...
		.def("getConnectednessYield", &CyCity::getConnectednessYield, "int (eBuilding, eYield)")
		.def("getConnectedDomesticCities", &CyCity::getConnectedDomesticCities, "int ()")
		.def("getConnectedForeignCities", &CyCity::getConnectedForeignCities, "int ()")
		.def("getDomesticConnectednessCommerce", &CyCity::getDomesticConnectednessCommerce, "int ()")
		.def("getForeignConnectednessCommerce", &CyCity::getForeignConnectednessCommerce, "int ()")
		.def("getTotalSeizedConnectednessCommerceTimes100", &CyCity::getTotalSeizedConnectednessCommerceTimes100, "int ()")

		.def("isDisabledBuilding", &CyCity::isDisabledBuilding, "bool (eBuilding)")
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
