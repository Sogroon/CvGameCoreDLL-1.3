...
// PARALLEL MAPS MODIFIED FUNCTION
	...
	bool bugInitCalled(void) const;
	bool multiMapsEnabled(void) const;
	bool viewportsEnabled(void) const;
	bool getReprocessGreatWallDynamically(void) const;
	int getNumMapInfos();
	int getNumMapSwitchInfos();
	std::vector<CvMapInfo*>& getMapInfo();
	std::vector<CvMapSwitchInfo*>& getMapSwitchInfo();
	...
	void clearSigns(void);
	void reprocessSigns(void);
	void setResourceLayer(bool bOn);
	bool getResourceLayer(void) const;
/*******************************/
/***** Parallel Maps - End *****/
/*******************************/
...
/************************************************************************************************/
	...
	bool getDoCaching();
	void setDoCaching(bool bCache);
	bool getWriteCache();
	void setWriteCache(bool bWriteCache);
...
/************************************************************************************************/
	...
	int getNumCivNameInfos();
	std::vector<CvCivNameInfo*>& getCivNameInfo();
	CvCivNameInfo& getCivNameInfo(CivNameTypes e);
...
/************************************************************************************************/
	...
	float getDefineFLOAT( const char * szName, float defValue = 0) const;
...
/************************************************************************************************/
	...
	TeamTypes getTurnActiveTeam() const;
	void setTurnActiveTeam(TeamTypes eTeam);
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
...
extern volatile int giProfilerDisabled;  // set to 1 or more in threaded areas as the profiler is not thread safe
