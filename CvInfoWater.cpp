...
bool CvWaterPlaneInfo::read(CvXMLLoadUtility* pXML)
{
	...
	//int j;
	if (GETXML->SetToChildByTagName(pXML->GetXML(),"WaterMaterial"))
	{
		if (GETXML->SetToChildByTagName(pXML->GetXML(),"MaterialColors"))
		{
			if (GETXML->SetToChildByTagName(pXML->GetXML(),"DiffuseMaterialColor"))
			{
			...
			if (GETXML->SetToChildByTagName(pXML->GetXML(),"SpecularMaterialColor"))
			{
			...
			if (GETXML->SetToChildByTagName(pXML->GetXML(),"EmmisiveMaterialColor"))
			{
	...
	if (GETXML->SetToChildByTagName(pXML->GetXML(),"WaterTextures"))
	{
		if (GETXML->SetToChildByTagName(pXML->GetXML(),"WaterBaseTexture"))
		{
		...
		if (GETXML->SetToChildByTagName(pXML->GetXML(),"WaterTransitionTexture"))
		{
			pXML->GetChildXmlValByName( szTextVal, "TextureFile");
