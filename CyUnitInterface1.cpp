...
/************************************************************************************************/
		.def("canGoodwill", &CyUnit::canGoodwill, "bool (CyPlot* pPlot, bool bTestVisible)")
/************************************************************************************************/
...
/************************************************************************************************/
		...
		.def("IsPirate", &CyUnit::IsPirate, "bool ()")		
...
// Thomas SG - AC: Advanced Cargo START
		.def("getSpecialCargo", &CyUnit::specialCargo, "int ()") 
		.def("getNumSpecialUnitTypes", &CyUnit::getNumSpecialUnitTypes, "int ()")
