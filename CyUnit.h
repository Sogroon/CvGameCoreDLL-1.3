...
/************************************************************************************************/
	bool canGoodwill( CyPlot* pPlot, bool bTestVisible);
/************************************************************************************************/
...
// Thomas SG - AC: Advanced Cargo START
	int /*SpecialUnitTypes*/ getSpecialUnitType(int i);	
	int getNumSpecialUnitTypes();												 
...
// Thomas SG - AC: Advanced Cargo START
	int /*SpecialUnitTypes*/ specialCargo(int iI);													 
// Thomas SG - AC: Advanced Cargo END
