...
bool CvPropertyManipulators::read(CvXMLLoadUtility *pXML, const TCHAR* szTagName)
{
	if(GETXML->SetToChildByTagName( pXML->GetXML(), szTagName))
	{
		if(GETXML->SetToChild( pXML->GetXML() ))
		{
			...
			if (GETXML->LocateFirstSiblingNodeByTagName(pXML->GetXML(), "PropertySource"))
			{
				do
				{
					CvString szTextVal;
				...
				} while(GETXML->LocateNextSiblingNodeByTagName(pXML->GetXML(), "PropertySource"));
			}
			if (GETXML->LocateFirstSiblingNodeByTagName(pXML->GetXML(), "PropertyInteraction"))
			{
				do
				{
					CvString szTextVal;
				...
				} while(GETXML->LocateNextSiblingNodeByTagName(pXML->GetXML(), "PropertyInteraction"));
			}
			if (GETXML->LocateFirstSiblingNodeByTagName(pXML->GetXML(), "PropertyPropagator"))
			{
				do
				{
					CvString szTextVal;
				...
				} while(GETXML->LocateNextSiblingNodeByTagName(pXML->GetXML(), "PropertyPropagator"));
			}
