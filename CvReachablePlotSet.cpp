...
CvPlot*	CvReachablePlotSet::const_iterator::plot(void)
{
...
int CvReachablePlotSet::const_iterator::stepDistance(void)
{
	if ( m_itr == m_parent.end().m_itr )
	{
		return MAX_INT;
...
int CvReachablePlotSet::const_iterator::outsideBorderDistance(void)
{
	if ( m_itr == m_parent.end().m_itr )
	{
		return MAX_INT;
...
CvReachablePlotSet::const_iterator CvReachablePlotSet::begin(void)
{
...
CvReachablePlotSet::const_iterator CvReachablePlotSet::end(void)
{
...
int CvReachablePlotSet::getRange(void) const
{
	if ( m_proxyTo == NULL )
	{
		return m_iRange;
...
void CvReachablePlotSet::ClearCache(void)
{
