...
// Movement Limits by 45deg - END
		...
		.def("getNumTechArrowOverrides", &CvTechInfo::getNumTechArrowOverrides, "int ()")
		.def("getTechArrowOverride", &CvTechInfo::getTechArrowOverride, "int (int i)")
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
		;
	...
	python::class_<CvPromotionInfo, python::bases<CvInfoBase> >("CvPromotionInfo")
		...
		.def("isIsPirate", &CvPromotionInfo::isIsPirate, "bool ()")
...
/************************************************************************************************/			
		...
		.def("isPrereqOrCivics", &CvPromotionInfo::isPrereqOrCivics, "bool (int i)")
		.def("isPrereqAndCivics", &CvPromotionInfo::isPrereqAndCivics, "bool (int i)")
		;
...
// Thomas SG - AC: Advanced Cargo START
		.def("getSpecialCargo", &CvUnitInfo::getSpecialCargo, "int (int i)")
...
// Thomas SG - AC: Advanced Cargo START
		.def("getSpecialUnitType", &CvUnitInfo::getSpecialUnitType, "int (int i)")
		.def("getNumSpecialUnitTypes", &CvUnitInfo::getNumSpecialUnitTypes, "int ()")
// Thomas SG - AC: Advanced Cargo END
...
/************************************************************************************************/
		...
		.def("getOverrideResourceBuilding", &CvUnitInfo::getOverrideResourceBuilding, "int ()")		
...
/************************************************************************************************/
		.def("isGoodwill", &CvUnitInfo::isGoodwill, "bool ()")
/************************************************************************************************/
...
/************************************************************************************************/
	...
	python::class_<CvCivicInfo, python::bases<CvInfoBase> >("CvCivicInfo")
		...
		.def("getStateReligionHealth", &CvCivicInfo::getStateReligionHealth, "int ()")		
...
/************************************************************************************************/
		...
		.def("isFreeReligion", &CvCivicInfo::isFreeReligion, "bool ()")
	...
	python::class_<CvBuildingInfo, python::bases<CvInfoBase, CvScalableInfo> >("CvBuildingInfo")
        ...
        .def("getNumFreeBuildingClass", &CvBuildingInfo::getNumFreeBuildingClass, "int ()")
		.def("getFreeBuildingClass", &CvBuildingInfo::getFreeBuildingClass, "int (int)")
		...
		.def("getWonderCapacityIncrement", &CvBuildingInfo::getWonderCapacityIncrement, "int ()")		
		...
		.def("getStateReligionHealth", &CvBuildingInfo::getStateReligionHealth, "int ()")		
...
/********************************************************************************/
		...
		.def("isNoPower", &CvBuildingInfo::isNoPower, "bool ()")		
		...
		.def("isFreeFromStateReligion", &CvBuildingInfo::isFreeFromStateReligion, "bool ()")		
