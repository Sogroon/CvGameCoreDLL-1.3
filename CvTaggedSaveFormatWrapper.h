...
#define WRAPPER_READ_CLASS_ARRAY_DECORATED_ALLOW_MISSING(wrapper,className,classType,count,name,saveName)	{ static int _idHint; static int _saveSeq = -1; (wrapper).ReadClassArray(className "::" saveName, _idHint, _saveSeq,classType,count,name,true); }
