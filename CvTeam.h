...
extern int AGBuilt; // Code added by 45° for Ascension Gate & Mastery Victory
...
public:
	...
	DllExport void init(TeamTypes eID, bool bDeclareWar);
...
// Movement Limits by 45deg - END	
	...
	void doEmbassyContactCheck();
	bool isTerritoryVisibleFromUnits(TeamTypes eTeam) const;
	bool isSharesBorderWith(TeamTypes eTeam) const;
/************************************************************************************************/
/* Afforess	                     END        		                                            */
/************************************************************************************************/	
	...
	bool isHasEverMet(TeamTypes eIndex) const;																		// Exposed to Python	// 45deg - embassies in Rhye's and fall style
/************************************************************************************************/
...
/************************************************************************************************/
	...
	bool isRival(TeamTypes eOther) const; // f1rpo
