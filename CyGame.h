...
//Sevo Begin--VCM
	...
	bool getAscensionGateBuilt(int ID); // code added for Ascension Gate & Mastery Victory (by 45�)
//Sevo End VCM
#endif
...
/************************************************************************************************/
	...
	void triggerDarkAge(float iDelayTurns, float iLenTurns, std::wstring szStartTxtKey, std::wstring szEndTxtKey);
