...
/************************************************************************************************/
		...
		.def("getNewCivName", &CyPlayer::getNewCivName, "wstring ()")
...
/************************************************************************************************/
		...
		.def("getInterest", &CyPlayer::getInterest, "int ()")		
...
/************************************************************************************************/
		...
		.def("getStateReligionHealth", &CyPlayer::getStateReligionHealth, "int ()")		
