...
// BUG - Building Additional Defense - end
	...
	int getWonderCapacityIncrement(int /*TeamTypes*/ eTeam);	
	int getNukeModifier();
...
/************************************************************************************************/
	...
	int getConnectednessYield(int eBuilding, int eYield);
	int getConnectedDomesticCities();
	int getConnectedForeignCities();
	int getDomesticConnectednessCommerce();
	int getForeignConnectednessCommerce();
	int getTotalSeizedConnectednessCommerceTimes100();

	bool isDisabledBuilding(int /*BuildingTypes*/ eBuilding);
/************************************************************************************************/
...
// BUG - Project Production - end
	...
	int getCurrentStateReligionHealth();
	int getStateReligionHealth(int /*ReligionTypes*/ eIndex);	
	void changeStateReligionHealth(int /*ReligionTypes*/ eIndex, int iChange);	
