...
bool CyCity::isNoPower()
{
	return m_pCity ? m_pCity->isNoPower() : false;
}
...
int CyCity::getCurrentStateReligionHealth()
{
	return m_pCity ? m_pCity->getCurrentStateReligionHealth() : -1;
}

int CyCity::getStateReligionHealth(int /*ReligionTypes*/ eIndex)
{
	return m_pCity ? m_pCity->getStateReligionHealth((ReligionTypes) eIndex) : -1;
}

void CyCity::changeStateReligionHealth(int /*ReligionTypes*/ eIndex, int iChange)
{
	if (m_pCity)
		m_pCity->changeStateReligionHealth((ReligionTypes) eIndex, iChange);
}
...
int CyCity::getConnectednessYield(int eBuilding, int eYield)
{
	if (m_pCity)
		return m_pCity->getConnectednessYield((BuildingTypes)eBuilding, (YieldTypes)eYield);
	return 0;
}

int CyCity::getConnectedDomesticCities()
{
	if (m_pCity)
		return m_pCity->getConnectedDomesticCities();
	return 0;
}

int CyCity::getConnectedForeignCities()
{
	if (m_pCity)
		return m_pCity->getConnectedForeignCities();
	return 0;
}

int CyCity::getDomesticConnectednessCommerce()
{
	if (m_pCity)
		return m_pCity->getDomesticConnectednessCommerce();
	return 0;
}

int CyCity::getForeignConnectednessCommerce()
{
	if (m_pCity)
		return m_pCity->getForeignConnectednessCommerce();
	return 0;
}

int CyCity::getTotalSeizedConnectednessCommerceTimes100()
{
	if (m_pCity)
		return m_pCity->getTotalSeizedForeignConnectednessTimes100();
	return 0;
}
/************************************************************************************************/
/* Afforess	                     END                                                            */
...
bool CyCity::isDisabledBuilding(int eBuilding)
{
	return m_pCity ? m_pCity->isDisabledBuilding((BuildingTypes)eBuilding) : false;
}
/*
