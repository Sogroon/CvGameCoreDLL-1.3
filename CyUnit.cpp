...
/************************************************************************************************/
bool CyUnit::canGoodwill(CyPlot* pPlot, bool bTestVisible)
{
	return m_pUnit ? m_pUnit->canGoodwill(pPlot->getPlot(), bTestVisible) : false;
}
/************************************************************************************************/
...
int /*SpecialUnitTypes*/ CyUnit::getSpecialUnitType(int i)
{
	return m_pUnit ? (int) m_pUnit->getSpecialUnitType(i) : (int) NO_SPECIALUNIT;
}

int CyUnit::getNumSpecialUnitTypes()
{
	return m_pUnit ? (int) m_pUnit->getNumSpecialUnitTypes() : 0;
}
...
bool CyUnit::IsPirate()
{
	return m_pUnit ? m_pUnit->isPirate() : false;
}
...
// Thomas SG - AC: Advanced Cargo START
int /*SpecialUnitTypes*/ CyUnit::specialCargo(int iI)
{
	return m_pUnit ? (int) m_pUnit->getSpecialCargo(iI) : (int) NO_SPECIALUNIT;
}
// Thomas SG - AC: Advanced Cargo END
