...
void CyInfoPythonInterface3()
{
	...
	python::class_<CvLeaderHeadInfo, python::bases<CvInfoBase> >("CvLeaderHeadInfo")
		...
		.def("getGender", &CvLeaderHeadInfo::getGender, "int ()") // f1rpo (Sexism)
		.def("getRace", &CvLeaderHeadInfo::getRace, "int ()") // f1rpo (Racism)
		...
		.def("getCivicAIWeight", &CvLeaderHeadInfo::pyCivicAIWeight, "int (int iCivic)") // f1rpo (Civic AI Weight)
		.def("getSexistAttitudeChange", &CvLeaderHeadInfo::pySexistAttitudeChange, "int (int iGender)") // f1rpo (Sexism)
		.def("getRacistAttitudeChange", &CvLeaderHeadInfo::pyRacistAttitudeChange, "int (int iRace)") // f1rpo (Racism)
	...
	python::class_<CvProjectInfo, python::bases<CvInfoBase> >("CvProjectInfo")
		...
		.def("isSpaceprogram", &CvProjectInfo::isSpaceprogram, "bool ()")		
