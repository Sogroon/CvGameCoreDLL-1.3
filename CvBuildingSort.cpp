...
void BuildingSortList::init(void)
{
	...
	m_apBuildingSort[BUILDING_SORT_CRIME] = new BuildingSortProperty((PropertyTypes)NO_PROPERTY);
	...
	m_apBuildingSort[BUILDING_SORT_FLAMMABILITY] = new BuildingSortProperty((PropertyTypes)NO_PROPERTY);
}
