...
/************************************************************************************************/
		...
		.def("calculateTributeReceived", &CyPlayer::calculateTributeReceived, "int ()")
		.def("getTributeReceived", &CyPlayer::getTributeReceived, "int (int ePlayer)")
		.def("calculateTributePayment", &CyPlayer::calculateTributePayment, "int ()")
		.def("calculateTotalForeignConnectednessSeized", &CyPlayer::calculateTotalForeignConnectednessSeized, "int ()")
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
		...
		.def("getRequestAction", &CyPlayer::getRequestAction, "DiplomacyRequestAction (int, int)")
		.def("setRequestAction", &CyPlayer::setRequestAction, "void (int, int, int)")
		.def("isAllowsAmbassadors", &CyPlayer::isAllowsAmbassadors, "bool ()")
		;
}
