...
protected:
	...
	void readOptionalArray(FDataStreamBase* pStream, bool*& paiValue);
	void writeOptionalArray(FDataStreamBase* pStream, int iSize, bool* paiValue);
	void readOptionalArray(FDataStreamBase* pStream, int*& paiValue);
	void writeOptionalArray(FDataStreamBase* pStream, int iSize, int* paiValue);
	void readOptionalArray(FDataStreamBase* pStream, CvString*& paszValues);
	void writeOptionalArray(FDataStreamBase* pStream, int iSize, CvString* paszValues);
	void readVector(FDataStreamBase* pStream, std::vector<int> aiValues);
	void writeVector(FDataStreamBase* pStream, std::vector<int> aiValues);
	void readOptional2DArray(FDataStreamBase* pStream, bool**& paabValues);
	void writeOptional2DArray(FDataStreamBase* pStream, int outerSize, int innerSize, bool** paabValues);
	void readOptional2DArray(FDataStreamBase* pStream, int**& paabValues);
	void writeOptional2DArray(FDataStreamBase* pStream, int outerSize, int innerSize, int** paabValues);
...
// Movement Limits by 45deg - END
	...
	int getNumTechArrowOverrides() const;
	int getTechArrowOverride(int i) const;
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
...
// Movement Limits by 45deg - START
	bool m_bExtendMovementLimits;
	bool m_bRemoveMovementLimits;
// Movement Limits by 45deg - END
	...
	int m_iNumTechArrowOverrides;
	int* m_piTechArrowOverrides;
...
public:
	...
	bool isIsPirate() const;				// Exposed to Python
	...
	bool isPrereqOrCivics(int iCivic) const;				// Exposed to Python
	bool isPrereqAndCivics(int iCivic) const;				// Exposed to Python
...
/************************************************************************************************/
	DllExport int getUpgradeImprovementRate(int i) const;
	bool isUpgradeImprovementRateArrayValid() const;
/************************************************************************************************/
...
/* Great Diplomat MOD               START                                                  		*/
/************************************************************************************************/
	std::vector<int> m_piUpgradeImprovementRate;
/************************************************************************************************/
/* Great Diplomat MOD               END                                                  		*/
/************************************************************************************************/
};
...
//	int getSpecialUnitType() const;						// Exposed to Python
	int getSpecialUnitType(int i) const;					// Exposed to Python
	int getNumSpecialUnitTypes() const;
// Thomas SG - AC: Advanced Cargo END
	...
	int getAdvisorType() const;								// Exposed to Python
// Thomas SG - AC: Advanced Cargo START
	int getSpecialCargo(int i) const;						// Exposed to Python			
	int getNumSpecialCargos() const;						// Exposed to Python			
	int getSpecialCargoSpace(int i) const;						// Exposed to Python			
	int getNumSpecialCargoSpaces() const;					// Exposed to Python
	int getTotalCargoSpace() const;							// Exposed to Python
...
/********************************************************************************/
	...
	int getOverrideResourceBuilding() const;						// Exposed to Python	
...
/************************************************************************************************/
	bool isBribeBarbarian() const; 					// Exposed to Python
	bool isBarbariansColonisator() const;				// Exposed to Python
	bool isGoodwill() const; 					// Exposed to Python
	bool canForcePeace() const;				// Exposed to Python
	bool isUpgradeImprovements() const;				// Exposed to Python
/************************************************************************************************/
/* Great Diplomat MOD               fEND                                                  		*/
/************************************************************************************************/	
...
/********************************************************************************/
	...
	int m_iOverrideResourceBuilding;	
...
/* Great Diplomat MOD               START                                      Stolenrays 		*/
/************************************************************************************************/
	bool m_bBribeBarbarian;
	bool m_bBarbariansColonisator;
	bool m_bGoodwill;
	bool m_bForcePeace;
	bool m_bUpgradeImprovements;
/************************************************************************************************/
/* Great Diplomat MOD               END                                                  		*/
/************************************************************************************************/	
	bool m_bInvestigate;
...
// Thomas SG - AC: Advanced Cargo START
	std::vector<int> m_aiSpecialUnitTypes;
	std::vector<int> m_aiSpecialCargos;
	std::vector<int> m_aiSpecialCargoSpaces;
// Thomas SG - AC: Advanced Cargo END
...
//keldath culture safe zone
	int getNoForeignCityCultureGrowth() const;				// Exposed to Python
//keldath culture safe zone
	...
	int getStateReligionHealth() const;				// Exposed to Python	
...
/************************************************************************************************/
	...
	bool isFreeReligion() const;				// Exposed to Python
...
/************************************************************************************************/
	...
	bool isForbiddenCivic(int i) const;								// Exposed to Python
...
/************************************************************************************************/
	...
	int getForbiddenCivicVectorSize();
	CvString getForbiddenCivicNamesVectorElement(int i);
	int getForbiddenCivicValuesVectorElement(int i);		
	...
	int getTributePercent() const;
	int getPowerfulRelationsChange() const;
	int getWeakestRelationsChange() const;
	int getLessPowerfulRelationsChange() const;
	int getGlobalRelationsChange() const;
	int getDomesticConnectednessModifier() const;
	int getForeignConnectednessModifier() const;
	int getSeizedForeignConnectednessPercent() const;
	bool isCanNotCeaseRelations() const;
	bool isForcesOpenTradeWithWeakerPlayers() const;
	
	int getPopulationAngerModifier() const;

protected:

	int m_iTributePercent;
	int m_iPowerfulRelationsChange;
	int m_iWeakestRelationsChange;
	int m_iLessPowerfulRelationsChange;
	int m_iGlobalRelationsChange;
	int m_iDomesticConnectednessModifier;
	int m_iForeignConnectednessModifier;
	int m_iSeizedForeignConnectednessPercent;
	bool m_bCanNotCeaseRelations;
	bool m_bForcesOpenTradeRoutesWithWeakerPlayers;
	
	int m_iPopulationAngerModifier;
	...
	bool* m_pabForbiddenCivic;
	std::vector<CvString> m_aszForbiddenCivicforPass3;
	std::vector<int> m_abForbiddenCivicforPass3;
...
protected:
	...
	int m_iCorporationMaintenanceModifier;					
//keldath culture safe zone	
	int m_iNoForeignCityCultureGrowth;
//keldath culture safe zone
	int m_iExtraHealth;
...
public:
    ...
    // DarkLunaPhantom - Extra FreeBuilding entries (cf. BuildingsSchema xml).
    int getNumExtraFreeBuildingClass() const;
    int getExtraFreeBuildingClass(int i) const;
    bool getExtraFreeBuildingConnected(int i) const;
    bool getExtraFreeBuildingContinuous(int i) const;
	...
	int getWonderCapacityIncrement() const;				// Exposed to Python	
	...
	int getTradeRoutes() const;				// Exposed to Python
	int getInterestPercent() const;				// Exposed to Python
	int getInterestMax() const;				// Exposed to Python	
...
/************************************************************************************************/
	...
	bool isNukeImmune() const;				// Exposed to Python
	bool isPrereqReligion() const;				// Exposed to Python
	bool isFreeFromStateReligion() const;				// Exposed to Python	
...
/************************************************************************************************/
	...
	int getExtraCapitalCommerce() const;
	int getExtraForeignCapitalCommerce() const;

	int getDomesticConnectedCommerce() const;
	int getCitiesRequiredPerDomesticConnectedCommerce() const;
	int getMaxDomesticConnectedCommerce() const;
	int getForeignConnectedCommerce() const;
	int getCitiesRequiredPerForeignConnectedCommerce() const;
	int getMaxForeignConnectedCommerce() const;

	int getDiplomacyChange() const;
	int getMemoryTypeModifier(int i) const;
...
protected:
	...
	int m_iCapitalExtraCommerce;
	int m_iForeignCapitalExtraCommerce;
	int m_iDomesticConnectedCommerce;
	int m_iCitiesRequiredPerDomesticConnectedCity;
	int m_iMaxDomesticConnectedCommerce;
	int m_iForeignConnectedCommerce;
	int m_iCitiesRequiredPerForeignConnectedCity;
	int m_iMaxForeignConnectedCommerce;
	int m_iDiplomacyChange;
	...
	bool m_bAllowsAmbassadors;

	int* m_piMemoryTypeModifier;
	...
	int** m_ppaiSpecialistCommercePercentChanges;
public:
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
...
protected:
    ...
    // DarkLunaPhantom - Extra FreeBuilding entries (cf. BuildingsSchema xml).
    std::vector<int> m_aiExtraFreeBuildingClass;
    std::vector<bool> m_abExtraFreeBuildingConnected;
    std::vector<bool> m_abExtraFreeBuildingContinuous;
...
public:
	...
	int getAIResearchPercent() const;				// Exposed to Python
...
/* Great Diplomat MOD               START                                                  		*/
/************************************************************************************************/
	const TCHAR* getImprovementUpgradeString() const;
	void setImprovementUpgradeString(const TCHAR* szVal);
/************************************************************************************************/
/* Great Diplomat MOD               END                                                  		*/
/************************************************************************************************/
...
/************************************************************************************************/
	...
	int getMaximumPerWorld() const;
	int getMinimumPerWorld() const;
/************************************************************************************************/
...
/************************************************************************************************/
	bool m_bPeaks;
	bool m_bCurrency;
	int m_iMinimumPerWorld;
	int m_iMaximumPerWorld;
/************************************************************************************************/
/* Afforess	Mountains End       END        		                                             */
/************************************************************************************************/
	bool m_bFlatlands;
...
/************************************************************************************************/
	...
	int getNumCityUnhappinessDivisor() const;
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
...
/************************************************************************************************/
	...
	int m_iNumCitiesUnhappinessDivisor;
/************************************************************************************************/
/* Afforess	                     END                                                            */
/************************************************************************************************/
	IDValueMapPercent m_Percent;
...
public:
	...
	bool isSpaceprogram() const;											// Exposed to Python	
...
*/
	int getEditedTrait() const;
	//TraitTypes getEditedTrait() const;
	GameOptionTypes getForGameOption() const;
	//OptionEditsConnections
	void resetOptionEdits();
	int getOptionEditsIndex() const;
	void setOptionEditsIndex();
	bool isOptionEditsIndexCached() const;
	void setOptionEditsIndexUncached();
	bool read(CvXMLLoadUtility* pXML);
...
public:
	...
	bool isExtraCultureLevel() const;
	int getYieldChange(int i) const;
//---------------------------------------PROTECTED MEMBER VARIABLES---------------------------------
protected:
	int* m_piBonusHappinessChanges;
...
//	bool* m_pabFreePromotionUnitCombat;
	...
	//OptionEdits
	GameOptionTypes m_eForGameOption;
	TraitTypes m_eEditedTrait;
	int m_iOptionEditsIndex;
	bool m_bOptionEditsIndexCached;
};
...
/************************************************************************************************/
	...
	void setTechCostModifier(int iCost);
/************************************************************************************************/
/* BETTER_BTS_AI_MOD                       END                                                  */
/************************************************************************************************/
	int getTrainCostModifier() const;
	void setTrainCostModifier(int iCost);
	int getConstructCostModifier() const;
	void setConstructCostModifier(int iCost);
	int getCreateCostModifier() const;
	void setCreateCostModifier(int iCost);	
	int getBuildPercent() const;					//	Exposed to Python
	int getImprovementPercent() const;		//	Exposed to Python
	int getGreatPeoplePercent() const;		//	Exposed to Python
	int getAnarchyPercent() const;				//	Exposed to Python
...
/* BETTER_BTS_AI_MOD                       END                                                  */
/************************************************************************************************/
	int m_iTrainCostModifier;
	int m_iConstructCostModifier;
	int m_iCreateCostModifier;
	int m_iBuildPercent;
	int m_iImprovementPercent;
	int m_iGreatPeoplePercent;
	int m_iAnarchyPercent;
...
public:
	...
	static void setLanguage(CvString szLanguage) { m_szLanguage = szLanguage; }

protected:

	static CvString m_szLanguage;
...
public:
	...
	int getChar() const;
	void setChar(int i);
	//int getFontButtonIndex() const; //might have to remove this, might cause troubles, by 45 deg
...
protected:
	...
	int m_iChar;
	//int m_iFontButtonIndex; //might have to remove this, might cause troubles, by 45 deg
...
// AIAndy: Dynamic Civ Names based on XML and expressions
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//
//  class : CvCivNameInfo
//
//  DESC:   Contains dynamic civ names
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
class CvCivNameInfo : 
	public CvInfoBase
...
public:
	...
	CvCivNameInfo();
	virtual ~CvCivNameInfo();

	bool isPrefix() const;
	bool isSuffix() const;

	int getNumPrefix() const;
	int getNumSuffix() const;

	bool getUsesCapital() const;
	bool getUsesCiv() const;
	bool getUsesLeader() const;

	BoolExpr* getPlayerCondition();
	BoolExpr* getCapitalCondition();

	CvWString& getNameKey();
	
	bool read(CvXMLLoadUtility* pXML);
	void copyNonDefaults(CvCivNameInfo* pClassInfo, CvXMLLoadUtility* pXML);
	void getCheckSum(unsigned int& iSum);

protected:
	BoolExpr* m_pExprPlayerCondition;
	BoolExpr* m_pExprCapitalCondition;

	bool m_bPrefix;
	bool m_bSuffix;

	// This declares if the name needs a prefix or suffix and how many. They are passed first to getText
	int m_iNumPrefix;
	int m_iNumSuffix;
	
	// The following bools declare what to pass to the getText function and make sure that the same are not used in prefix or suffix
	bool m_bUsesCapital;
	bool m_bUsesCiv;
	bool m_bUsesLeader;

	CvWString m_szNameKey;
